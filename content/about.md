...
No. You could boot up a VM with [Kali Linux](https://kali.org), the de facto OS for hackers, but it is not required to participate. The more technical challenges will often include a quick guide on how to use the relevant tools, and like any CTF, we allow free access to the Internet during the competition, so no need to study anything.
